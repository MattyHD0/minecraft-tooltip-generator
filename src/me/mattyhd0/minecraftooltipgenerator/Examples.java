...
import me.mattyhd0.minecraftooltipgenerator.generator.TooltipBuilder;
...
public class Examples {
    ...
    public static void main(String[] arg){
        ...
        minecraftTooltipGenerator();
        diamondSwordExample();
        hypixelHyperionExample();

    }

    public static void minecraftTooltipGenerator(){

        new TooltipBuilder()
                .setColorCode("&")
                .setBetterMagic(true)
                .setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 100))
                .setName("&6Minecraft Tooltip Generator")
                .addLore("&7Minecraft Tooltip Generator is a minecraft tooltip creator")
                .addLore("&7just like the name says (bruh)")
                .addLore("")
                .addLore("&7Formatting:")
                .addLore("&4§4 &c§c &6§6 &y§e")
                .addLore("&2§2 &a§a &b§b &3§3")
                .addLore("&1§1 &9§9 &d§d &5§5")
                .addLore("&f§f &7§7 &8§8 &0§0")
                .addLore("&kMagic&r &lBold&r &oItalic")
                .addLore("&mStrike&r &nUnderline&r &rReset")
                .save("minecraft_tooltip_generator.png");
